...
demag_tensor_file = "demag_tensor_64x64x1.npy"
...
np.save("solver_skyrmion/noDMI_before_relaxation.npy", m)
...
np.save("solver_skyrmion/noDMI_after_relaxation.npy", m)
...
np.save("solver_skyrmion/noDMI_after_1ns.npy", m)